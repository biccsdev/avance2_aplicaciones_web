...
public class ResenaBO implements IResenaBO {
    ...
    public void crearResena(ResenaDTO dto) throws NegocioException {
        try {
            ...
            if (dto == null) {
                throw new NegocioException("La reseña está vacia.");
            }

            if (dto.getCalificacion() < 1) {
                throw new NegocioException("La reseña debe tener una calificacion.");
            }

            if (dto.getComentario() == null) {
                throw new NegocioException("La reseña debe tener un comentario.");
            }
    ...
    public void eliminarResena(Long idResena) throws NegocioException {
        try {
            ...
            if (idResena == null) {
                throw new NegocioException("El ID de la reseña es obligatorio.");
            }

            // Verificar existencia antes de intentar borrar
            if (this.resenaDAO.buscarPorId(idResena) == null) {
                throw new NegocioException("La reseña que intenta eliminar no existe.");
            }
    ...
    public List<ResenaDTO> buscarPorVideojuego(Long idVideojuego) throws NegocioException {
        try {
            ...
            if (idVideojuego == null) {
                throw new NegocioException("ID de videojuego requerido.");
            }
    ...
    public ResenaDTO buscarPorVideojuegoCliente(Long idCliente, Long idVideojuego) throws NegocioException {
        try {
            ...
            if (idCliente == null || idVideojuego == null) {
                return null;
            }
    ...
    public List<ResenaDTO> buscarResenasPorCalificacion(Float calificacion) throws NegocioException {
        try {
            ...
            if (calificacion == null) {
                throw new NegocioException("Calificación requerida.");
            }
