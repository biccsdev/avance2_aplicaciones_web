                        ...
                        <form id="registro" class="form" action="${pageContext.request.contextPath}/register" method="post">
                            <div>
                                ...
                                <input class="input" id="email" name="email" type="email" autocomplete="email"
                                       placeholder="Ingresa tu correo electrónico" value="${param.email}" required>
                            </div>
                            ...
                            <div class="form-label">
                                ...
                                <input class="input" id="nombre" name="nombre" type="text" autocomplete="given-name"
                                       placeholder="Ingresa tus nombre(s)" value="${param.nombre}" required>
                            </div>
                            ...
                            <div class="form-label">
                                <label class="form-label" for="registro">Apellido Materno</label>
                                <input class="input" id="apellidoMaterno" name="apellidoMaterno" type="text" autocomplete="family-name"
                                       placeholder="Ingresa tu apellido materno" value="${param.apellidoMaterno}">
                            </div>

                            <div class="field-row">
                                <div class="field">
                                    <label class="form-label" for="registro">Colonia<span aria-hidden="true">*</span></label>
                                    <input class="input" id="colonia" name="colonia" type="text" placeholder="Colonia" value="${param.colonia}" required>
                                </div>
                                <div class="field">
                                    <label class="form-label" for="registro">Calle<span aria-hidden="true">*</span></label>
                                    <input class="input" id="calle" name="calle" type="text" placeholder="Calle" value="${param.calle}" required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input class="input" id="numero" name="numero" type="text" inputmode="numeric"
                                       placeholder="Número exterior" value="${param.numero}" required>
                            </div>

                            <div>
                                <label class="form-label" for="registro">Teléfono<span aria-hidden="true">*</span></label>
                                <input class="input" id="telefono" name="telefono" type="tel" inputmode="tel" autocomplete="tel"
                                       placeholder="+52" value="${param.telefono}" required>
                            </div>
