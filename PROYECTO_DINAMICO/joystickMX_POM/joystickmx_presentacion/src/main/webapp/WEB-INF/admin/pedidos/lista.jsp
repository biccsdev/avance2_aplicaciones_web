                        ...
                        <div class="order-status">
                            <form class="admin-controls" method="POST" action="${pageContext.request.contextPath}/admin/pedidos/gestionar">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <span class="status-label">${pedido.estadoPedido}</span>
                                        <span class="dot dot-active" style="background-color: gray;"></span>
                                    </c:otherwise>
                                </c:choose>
                            </div>

                                <c:set var="esFinalizado" value="${pedido.estadoPedido == 'ENTREGADO' || pedido.estadoPedido == 'CANCELADO'}" />

                                <c:choose>
                                    <c:when test="${esFinalizado}">
                                        <div style="margin-top: 10px; font-size: 0.85rem; color: #666; font-style: italic;">
                                            Este pedido ha finalizado y no se puede modificar.
                                        </div>
                                    </c:when>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <button type="submit" class="btn btn-primary" style="font-size: 0.8rem; padding: 5px 15px; width: 100%;">Actualizar</button>
                                    </c:otherwise>
                                </c:choose>
