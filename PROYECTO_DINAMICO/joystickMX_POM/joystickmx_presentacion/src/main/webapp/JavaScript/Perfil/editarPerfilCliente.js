...
function validarInput(evento) {
    ...
    if (nombreCampo === 'nombres' || nombreCampo === 'apellidoPaterno' || nombreCampo === 'apellidoMaterno') {
        if (!REGEX_SOLO_LETRAS.test(valor)) {
            marcarError(input, "No se permiten números ni caracteres especiales en este campo.");
        } else {
            marcarValido(input); 
        }
    }
    ...
    // Validar el número exterior
        ...
        if (!REGEX_SOLO_NUMEROS.test(valor)) {
            marcarError(input, "No se permiten letras ni caracteres especiales en este campo.");
        } else {
            marcarValido(input); 
        }
    }
