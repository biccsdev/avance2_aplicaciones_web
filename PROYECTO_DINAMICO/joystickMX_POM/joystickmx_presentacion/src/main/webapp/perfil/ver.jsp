...
<html lang="es">
    <head>
        ...
        <script>
            ...
            const SERVER_MSG_SUCCESS = "${successMessage}"; //Mensaje de aprovación del servidor
            const SERVER_MSG_ERROR = "${errorMessage}"; // Mensaje de error
        </script>
        
        <script src="${pageContext.request.contextPath}/JavaScript/Perfil/perfilCliente.js" defer></script>
    </head>
